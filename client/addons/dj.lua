    ...
    CreateThread(function()
        ...
        while true do
            ...
            for k, v in pairs(Config.DJ.Locations) do
                ...
                local hasPerm = table.includes(v.allowedJobs, GetJobName()) or not v.allowedJobs
    ...
    CreateThread(function()
        for k, v in pairs(Config.DJ.Locations) do
            ...
            exports['qb-target']:AddBoxZone(id, enterCoords, 2.0, 2.0, {
                name = id, -- This must be the same with the first param
                heading = 90.0,
                debugPoly = false,
                ...
                options = {
                    {
                        ...
                        canInteract = function()
                            return table.includes(v.allowedJobs, GetJobName()) or not v.allowedJobs
                        end
                    }
                },
                distance = 2.5
